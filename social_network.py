...
print("Clustering Coefficient : ", nx.average_clustering(social_network))
print("Degree : ", social_network.degree()) # or social_network.degree('Itashi')
print("Efficiency : ", nx.global_efficiency(social_network))
